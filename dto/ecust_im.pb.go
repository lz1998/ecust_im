...
const (
	Request_TFriend Request_RequestType = 0
	Request_TGroup  Request_RequestType = 1
)
...
const (
	Msg_TFriend Msg_MsgType = 0
	Msg_TGroup  Msg_MsgType = 1
)
...
func (Packet_PacketType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_76254ce47462d67e, []int{21, 0}
}
...
func (m *Request) GetReqType() Request_RequestType {
	...
	return Request_TFriend
}

func (m *Request) GetFromId() int64 {
	if m != nil {
		return m.FromId
	}
	return 0
...
type Msg struct {
	MsgType              Msg_MsgType `protobuf:"varint,1,opt,name=msgType,proto3,enum=dto.Msg_MsgType" json:"msgType,omitempty"`
	...
	Elements             []*Elem     `protobuf:"bytes,4,rep,name=elements,proto3" json:"elements,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
func (m *Msg) GetMsgType() Msg_MsgType {
	if m != nil {
		return m.MsgType
	}
	return Msg_TFriend
...
func init() {
	...
	proto.RegisterEnum("dto.Msg_MsgType", Msg_MsgType_name, Msg_MsgType_value)
...
var fileDescriptor_76254ce47462d67e = []byte{
	...
	,
}
...
func (m *Request) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.FromId != 0 {
		i = encodeVarintEcustIm(dAtA, i, uint64(m.FromId))
		i--
		dAtA[i] = 0x18
	}
	if m.ReqType != 0 {
...
func (m *Request) Size() (n int) {
	...
	if m.FromId != 0 {
		n += 1 + sovEcustIm(uint64(m.FromId))
	}
	if m.ToId != 0 {
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MsgType |= Msg_MsgType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
